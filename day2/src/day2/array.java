...
public class array {
	...
	public static void main(String[] args) {
		// 배열(Array)
		// 지금까지 우리는 숫자와 문자열에 대해서 알아보았다. 하지만 이러한 것들로 프로그래밍을 하기엔 부족한 점이 많다. 예를 들어 1부터 10까지의 숫자들 중 홀수들의 모임인
		// 1, 3, 5, 7, 9 라는 집함을 생각해 보자. 이것들을 숫자나 문자열만으로 표현 하기는 쉽지 않다.
		...
		// 요일의 집함은 다음과 같이 String 배열로 표현 할 수 있다.
		// String[] weeks = {"월", "화", "수", "목", "금", "토", "일"};
		// 즉, 배열이란 자료형의 종류가 아닌 자료형의 집함을 의미한다.
		// 위에서 알아보 배열은 모두 1차원 배열이다. 2차원, 3차원 등의 다차원 배열도 가능한데 2차원 이상의 배열은 잘 사용하지 않는다.
		...
		// 단, 위 예처럼 초기값 없이 배열 변수를 만들때에는 반드시 길이에 대한 숫자값이 필요하다. 즉, 다음과 같은 코드는 불가능하다.
		...
		// 배열의 길이
		// 배열은 보통 for문과 함께 사용한다. for문에 배열이 사용될 경우 배열의 길이만큼 for 문을 돌리는 것이 중요한데 배열의 길이는 다음과 같이 length를 이용하여 구한다.
		// String[] weeks = {"월", "화", "수", "목", "금", "토", "일"};
