...
public class sample7 {
	public static void main(String[] args) {
		...
		// "객체"에 대해서는 나중에 자세하게 알아볼 것이다. 앞으로도 "객체"라는 용어가 계속해서 나올텐데 그때까지는
		// "새로 생성된 자료형"정도의 의미라고만 알고 있도록 하자.
		...
		// 위 예에서 리터럴 표기법은 "happy java" 라는 문자열 internpool 이라는 곳에 저장하고 다음에 다시 동일한 문자열이 선언될때는
		// chche 된 문자열을 리턴한다. 두번째 방식은 항상 새로운 String 객체를 만든다.
